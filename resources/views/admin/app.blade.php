...
<head>
    ...
    <link
        ...
        sizes="180x180"
        href="{{asset('adminVendors/images/apple-touch-icon.png')}}"
    />
    <link
        rel="icon"
        type="image/png"
        sizes="32x32"
        href="{{asset('adminVendors/images/favicon-32x32.png')}}"
    />
    <link
        rel="icon"
        type="image/png"
        sizes="16x16"
        href="{{asset('adminVendors/images/favicon-16x16.png')}}"
    />
    ...
    />
    <!-- CSS -->
    <link rel="stylesheet" type="text/css" href="{{asset('adminVendors/styles/core.css')}}" />
    <link
        rel="stylesheet"
        type="text/css"
        href="{{asset('adminVendors/styles/icon-font.min.css')}}"
    />
    <link
        rel="stylesheet"
        type="text/css"
        href="{{asset('admin/plugins/datatables/css/dataTables.bootstrap4.min.css')}}"
    />
    <link
        rel="stylesheet"
        type="text/css"
        href="{{asset('admin/plugins/datatables/css/responsive.bootstrap4.min.css')}}"
    />
    <link rel="stylesheet" type="text/css" href="{{asset('adminVendors/styles/style.css')}}" />
...
<div class="pre-loader">
    <div class="pre-loader-box">
        <div class="loader-logo">
            <img src="{{asset('adminVendors/images/deskapp-logo.svg')}}" alt="" />
        </div>
...
<script src="{{asset('adminVendors/scripts/core.js')}}"></script>
<script src="{{asset('adminVendors/scripts/script.min.js')}}"></script>
<script src="{{asset('adminVendors/scripts/process.js')}}"></script>
<script src="{{asset('adminVendors/scripts/layout-settings.js')}}"></script>
...
<script src="{{asset('admin/plugins/datatables/js/dataTables.bootstrap4.min.js')}}"></script>
<script src="{{asset('admin/plugins/datatables/js/dataTables.responsive.min.js')}}"></script>
<script src="{{asset('admin/plugins/datatables/js/responsive.bootstrap4.min.js')}}"></script>
